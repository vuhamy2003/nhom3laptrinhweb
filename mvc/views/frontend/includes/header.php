            ...
            <div class="row">
                <div class="box">
                    <p>Số điện thoại: <span> <i class="fas fa-phone"></i> <a
                                href="tel:0812021203">0812021203</a></span></p>
                </div>
                <div class="box">
                    <div class="button_sign">
                        <?php if (isset($_SESSION['user']) && $data_index['user'] !== null) { ?>
                            ...
                            <?= isset($data_index['user']['username']) ? htmlspecialchars($data_index['user']['username']) : 'Guest' ?>
    ...
    <section class="nagivation">
        <div class="container">
            ...
            <div class="box social">
                <ul>
                    <li><a href="https://www.facebook.com/miyukizumy/"><i class="fab fa-facebook"></i></a></li>
                </ul>
            </div>
        </div>
    </section>
